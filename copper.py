...
tab1, tab2, tab3 = st.tabs(["***HOME***&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", "***CLASSIFICATION***&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", "***REGRESSION***&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"])
...
with tab2:
  ...
  try:
    if A is not None and B >=0 and C >=0: 
    ...
    st.warning("Please Enter Valid Value For All")
...
with tab3:
  ...
  B = col2.number_input("Enter Thickness",value=None)
  C = col1.number_input("Enter Width",value=None)
  D = col2.number_input("Enter Item_Type(IPL,Others,PL,S,SLAWR,W,WI)", min_value=0, max_value=6, step=1,value=None)
  E = col1.number_input("Enter Product reference ID", min_value=0, max_value=32, step=1,value=None, key="product_ref_id")
  # F = col2.selectbox("Enter Year",["Select",2020,2021])
  F = col1.number_input("Enter Year",value=None)
  G = col1.number_input("Enter Month",min_value = 1,max_value= 12,value=None)
  ...
  J = col2.number_input("Enter Customer ID", min_value=0, max_value=1124, step=1,value=None, key="Customer_ID")
  K = col1.number_input("Enter Application ", min_value=0, max_value=29, step=1,value=None)
  try:
    if A is not None and B >0 and C >0 and D >=0 and E >=0 and H >=0 and I >=0 and J >=0 and K >=0 and F is not None and G >=1:
      Z = np.log(A)
      Y = np.log(B)
      with st.spinner("Please Wait..."):
